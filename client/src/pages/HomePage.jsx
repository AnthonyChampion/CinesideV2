...
import { fetchPopularMovies, fetchTopRatedMovies } from '../utils/moviedb';
...
export default function HomePage() {
    ...
    }, [getPopularMovies, getTopratedMovies, setSlidesPerview]);
        ...
        <div className="flex flex-col text-white bg-transparent z-50">
            <section>
                {loading ? (
                    ...
                    <>
                        <header className="w-full md:h-[75vh] h-full flex flex-col items-center mt-4 md:mt-8">
                                                ...
                                                <div className="flex-col p-4 md:space-y-2 text-white">
                                                    ...
                                                    <div className="absolute top-8 right-8 md:relative md:top-0 md:right-0 md:flex md:justify-end">
                                                        <Link to={`/film/${movie.id}`}>
                                                            <Button className='bg-red-700 border-none transform transition-transform 
                                                            duration-200 hover:scale-110'>Voir détails</Button>
                                                        </Link>
                                                    </div>
                                                </div>
                                            </div>
