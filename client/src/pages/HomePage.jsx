        ...
        <div className="flex flex-col dark:text-white bg-white dark:bg-transparent z-50">
            <section>
                {loading ? (
                    ...
                    <>
                        <header className="w-full md:h-[65vh] h-full flex flex-col items-center mt-8">
                                ...
                                >
                                    {trending.map((movie) => (
                                        <swiper-slide key={movie.id}>
                                            <div className="w-full flex-col h-full mt-2">
                                                <img
                                                    src={`https://image.tmdb.org/t/p/original${movie.poster_path}`}
                                                    alt={movie?.title || "Image du film"}
                                                    className="w-full md:h-[450px] h-[500px]"
                                                    onError={(e) => {
                        ...
                        <div className="hidden md:flex w-full items-center justify-center dark:bg-[#0a0a0b] mt-10">
