...
function Footer() {
    return (
        <footer className="dark:bg-[#101522] bg-white rounded-lg shadow m-4 dark:text-white text-[#101522] md:mt-20 mb-20 md:mb-0">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-[#101522] sm:mb-0 dark:text-gray-400">
                        ...
                        <Link to="/film_par_genre" className="hover:underline me-4 md:me-6">
                            Genres
                        </Link>
                        <Link to="/film_par_annee" className="hover:underline me-4 md:me-6">
                            Années
                        </Link>
                        <Link to="https://github.com/AnthonyChampion/CinesideV2" className="hover:underline me-4 md:me-6 dark:bg-transparent bg-[#101522] rounded-full">
